...
@Command(scope = "opennms-service-now", name = "get-parent-by-parent-map", description = "Get Parent Key Parent Node Data Map.")
@Service
public class GetParentByParentMapCommand implements Action {
    ...
    public Object execute() {
        final var table = new ShellTable()
                ...
                ;
        for (Map.Entry<String,String> entry : service.getParentByParentKeyMap().entrySet()) {
