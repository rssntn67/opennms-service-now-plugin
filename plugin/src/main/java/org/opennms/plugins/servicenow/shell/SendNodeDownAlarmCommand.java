...
@Command(scope = "opennms-service-now", name = "send-node-down-alarm", description = "Send Test Alarm Node Down.")
@Service
public class SendNodeDownAlarmCommand implements Action {
    ...
    public static Alarm getAlarm(int alarmId, int nodeId, String nodeLabel, String parentLabel) {
        return ImmutableAlarm.newBuilder()
                ...
                .setDescription("<p>All interfaces on node "+ nodeLabel + " are" +
                        " down because of the following condition: test event generated by service now plugin.</p> " +
                        "<p>" +
